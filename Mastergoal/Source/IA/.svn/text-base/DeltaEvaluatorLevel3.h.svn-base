#ifndef DELTA_EVALUATOR_LEVEL_3_H
#define DELTA_EVALUATOR_LEVEL_3_H

#include "DeltaEvaluator.h"

namespace AI
{
	class DeltaEvaluatorLevel3 : public DeltaEvaluator
	{
	public:
	...
	public:
		DeltaEvaluatorLevel3();

		DeltaEvaluatorLevel3(float weights[]);
