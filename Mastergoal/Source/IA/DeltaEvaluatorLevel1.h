#ifndef DELTA_EVALUATOR_LEVEL_1_H
#define DELTA_EVALUATOR_LEVEL_1_H

#include "DeltaEvaluator.h"

namespace AI
{
	class DeltaEvaluatorLevel1 : public DeltaEvaluator
	{
	public:
	...
	public:
		DeltaEvaluatorLevel1();

		DeltaEvaluatorLevel1(float weights[]);
